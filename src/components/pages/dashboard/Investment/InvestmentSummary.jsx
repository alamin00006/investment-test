...
const InvestmentSummary = ({ projectData }) => {
  ...
  const handleChange = (e) => {
    ...
    // Update state only if the value is a valid whole number
  ...
  const handleBlur = () => {
    setFormattedValue(investMentAmount.toLocaleString());
  };

  const handleFocus = () => {
    setFormattedValue(investMentAmount);
  };
        ...
        <div className="col-lg-6">
          ...
          <div className="mt-2">
            <label className="fw-bold">
              ...
              {projectData?.minimumInvestmentValue?.toLocaleString()} BDT)
            </label>
            <br />
            <input
              type="text"
